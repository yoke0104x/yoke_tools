(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.yokeTools = {}));
  ...
  var Calculator = (
    ...
    function() {
      ...
      Object.defineProperty(Calculator2.prototype, "subtract", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function() {
      ...
      Object.defineProperty(Calculator2.prototype, "multiply", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function() {
      ...
      Object.defineProperty(Calculator2.prototype, "divide", {
        enumerable: false,
        configurable: true,
        writable: true,
        value: function() {
  ...
  ***************************************************************************** */
  ...
  var tools = {
     ...
     * @returns
     */
    toList: function(tree, config) {
      config = getConfig(config !== null && config !== void 0 ? config : {});
      var children = config.children, result = __spreadArray([], tree, true);
     ...
     * @returns
     */
    findPath: function(tree, func, config) {
      config = getConfig(config !== null && config !== void 0 ? config : {});
      var path = [], list = __spreadArray([], tree, true), visitedSet = /* @__PURE__ */ new Set(), children = config.children;
      while (list.length) {
        var node = list[0];
     ...
     * @returns
     */
    findPathAll: function(tree, func, config) {
      config = getConfig(config !== null && config !== void 0 ? config : {});
      var path = [], list = __spreadArray([], tree, true), result = [];
      var visitedSet = /* @__PURE__ */ new Set(), children = config.children;
      while (list.length) {
        var node = list[0];
        if (visitedSet.has(node)) {
          path.pop();
          ...
          node[children] && list.unshift.apply(list, node[children]);
          path.push(node);
          func(node) && result.push(__spreadArray([], path, true));
        }
      }
      return result;
    },
     ...
     * @returns
     */
    filter: function(tree, func, config) {
      config = getConfig(config !== null && config !== void 0 ? config : {});
      var children = config.children;
     ...
     * @param config
     */
    forEach: function(tree, func, config) {
      config = getConfig(config !== null && config !== void 0 ? config : {});
      var list = __spreadArray([], tree, true), children = config.children;
      for (var i = 0; i < list.length; i++) {
        func(list[i]);
        list[i][children] && list.splice.apply(list, __spreadArray([i + 1, 0], list[i][children], false));
      }
    },
    /**
     * insert 辅助方法
     ...
     * @param after
     */
    _insert: function(tree, node, targetNode, config, after) {
      config = getConfig(config);
      var children = config.children;
     ...
     * @param config
     */
    insertBefore: function(tree, newNode, oldNode, config) {
     ...
     * @param config
     */
    insertAfter: function(tree, newNode, oldNode, config) {
     ...
     * @param config
     */
    removeNode: function(tree, func, config) {
      config = getConfig(config !== null && config !== void 0 ? config : {});
      var children = config.children, list = [tree];
      var _loop_1 = function() {
        ...
        list.push.apply(list, childrenList);
      };
      while (list.length) {
        _loop_1();
      }
  ...
  var makeHandlers = function() {
    ...
    for (var key in tools) {
      ...
      if (key.startsWith("_"))
        continue;
      obj[keyStr] = tools[key];
    }
    return obj;
  };
  var handlers = makeHandlers();
  var treeHandler = __assign(__assign({}, handlers), { createInstance: function(config) {
    var obj = {};
    var _loop_2 = function(key2) {
      var keyStr = key2;
      var func = handlers[keyStr];
      obj[keyStr] = function() {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
        ...
        if (typeof func === "function") {
          return func.apply(void 0, __spreadArray(__spreadArray([], args, false), [config], false));
        }
      };
    };
